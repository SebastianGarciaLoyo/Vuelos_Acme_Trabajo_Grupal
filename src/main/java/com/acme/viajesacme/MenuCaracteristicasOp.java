 ...
 * @author mateo
 */
public class MenuCaracteristicasOp {
    // Definiendo los constructores de la clase
    public MenuCaracteristicasOp() {
        
    }
    
    
    public static void elegirMenu(String rolUser) {
    ...
    }  //Fin función elegirMenu
}  //Fin clase MenuCaracteristicasOp
